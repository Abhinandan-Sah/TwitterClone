      ...
      <div className="grid grid-cols-12  h-screen w-screen px-56">
          ...
          <div className="mt-4 text-2xl">
            <ul className="flex flex-col gap-y-2">
              {SidebarMenuItems.map((item) => (
                <li
                  className="flex justify-start items-center gap-3 w-fit rounded-full px-2 py-2 cursor-pointer hover:bg-gray-800 transition-all"
                  key={item?.title}
                >
                  <span>{item?.icon}</span>
            ...
            <div className="flex justify-center px-4 mt-3 font-semibold">
              <button className="px-4 py-2 bg-blue-500 rounded-full w-full text-xl">
                Post
              </button>
            </div>
          </div>
        ...
        <div className="col-span-3 p-3">
          <div className="p-5 rounded-lg bg-slate-700">
            <h1 className="text-2xl font-semibold my-2">New to TwitterX?</h1>
